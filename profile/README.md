...
<img src="https://raw.githubusercontent.com/AnkleBreaker-Studio/unity-mcp-plugin/main/icon.png" alt="AnkleBreaker Studio" width="120" />

# AnkleBreaker Studio

**Game studio & AI toolsmiths** — we build AI-powered developer tools and immersive games.
...
Our MCP ([Model Context Protocol](https://modelcontextprotocol.io)) servers let AI assistants like **Claude**, **Cursor**, and **Windsurf** work directly inside the software you use every day — from **Unity Editor** to **Blender**, **Discord**, **Jira**, **GitHub**, **LinkedIn**, and more.

---

## 🎮 Unity MCP — Our Flagship Open-Source Project

> **The most comprehensive MCP integration for Unity game development. 268 tools. 30+ categories. Free forever.**
...
**AI builds a neon brick breaker game from scratch:**

<p align="center">
  <a href="https://github.com/AnkleBreaker-Studio/unity-mcp-server">
    <img src="https://raw.githubusercontent.com/AnkleBreaker-Studio/unity-mcp-server/main/docs/unity-mcp-showcase-brickbreaker.gif" alt="Unity MCP — AI building a neon brick breaker game" width="700" />
  </a>
</p>

**AI builds a 3D medieval village with terrain, houses, and trees:**

<p align="center">
  <a href="https://github.com/AnkleBreaker-Studio/unity-mcp-server">
    <img src="https://raw.githubusercontent.com/AnkleBreaker-Studio/unity-mcp-server/main/docs/unity-mcp-showcase-village.gif" alt="Unity MCP — AI building a 3D village" width="700" />
  </a>
</p>

**AI builds a 3D castle and runs an FPS walkthrough:**

<p align="center">
  <a href="https://github.com/AnkleBreaker-Studio/unity-mcp-server">
    <img src="https://raw.githubusercontent.com/AnkleBreaker-Studio/unity-mcp-server/main/docs/unity-mcp-showcase-castle.gif" alt="Unity MCP — AI building a 3D castle" width="700" />
  </a>
</p>

> **Unity MCP is and will always be free and open source.** Works with Claude Desktop, Claude Cowork, Cursor, Windsurf, and any MCP-compatible client.

---

## 🧩 Open-Source Unity Packages

Lightweight, dependency-free Unity packages — ready to drop into any project via UPM:
